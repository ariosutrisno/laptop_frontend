...
const DataAlternatif = ({navigation}) =>{
                ...
                <View style={styles.wrapper.components}>
                    ...
                    <Animated.FlatList
                        ...
                        renderItem={({item, index}) => {
                            ...
                            />
                            <View>
                                <Text style={{fontSize:14, fontWeight:'700'}}>NAMA KRITERIA :  Ram </Text>
                                <Text style={{fontSize:14, opacity:.7, fontWeight:'700'}}>BOBOT :  25 </Text>
                                <Text style={{fontSize:14, opacity:.7,fontWeight:'700',color:'black'}}>DESKRIPSI :  Lorem Ipsum </Text>
                            </View>
                            </Animated.View>
                        }}
                    />
